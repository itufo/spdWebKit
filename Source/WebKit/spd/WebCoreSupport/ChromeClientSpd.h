...
#ifndef ChromeClientSpd_h
#define ChromeClientSpd_h
#include "spdWebKit.h"
...
class ChromeClientSpd : public ChromeClient {
public:
    explicit ChromeClientSpd(spd_Object* view);
    virtual ~ChromeClientSpd();
